...
{
    unsigned int progam = glCreateProgram();
    unsigned int vs = CompileShader(GL_VERTEX_SHADER, vertexShader);
    unsigned int fs = CompileShader(GL_FRAGMENT_SHADER, fragmentShader);

    GLCall(glAttachShader(progam, vs));
    GLCall(glAttachShader(progam, fs));
    GLCall(glLinkProgram(progam));
    GLCall(glValidateProgram(progam));
